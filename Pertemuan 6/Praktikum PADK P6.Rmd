...
Hitunglah akurasi, sensitivitas, spesifisitas, dan presisi dari vaksin ini dalam mencegah infeksi influenza

**Jawab:**

```{r}
# Input  
masker <- matrix(c(30, 270, 70, 230), nrow = 2, byrow = TRUE,                                    dimnames = list("Prediksi" = c("Positif", "Negatif"),                                                 "Aktual" = c("Positif", "Negatif")))  
print(masker)
```

```{r}
# Menghitung metrik-metrik performa  
TP5 <- masker["Positif", "Positif"] #True Positive  
TP5

FP5 <- masker["Positif", "Negatif"] #False Positive  
FP5  

FN5 <- masker["Negatif", "Positif"] #False Negative  
FN5  

TN5 <- masker["Negatif", "Negatif"] #True Negative  
TN5
```
